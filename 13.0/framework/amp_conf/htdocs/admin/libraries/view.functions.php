...
function frameworkPasswordCheck() {
  ...
  //
	...
	if(get_magic_quotes_gpc()) {
		$nt->add_error('core', 'MQGPC', _("Magic Quotes GPC"), _("You have magic_quotes_gpc enabled in your php.ini, http or .htaccess file which will cause errors in some modules. Ringfree PBX expects this to be off and runs under that assumption"));
	} else {
