...
class Freepbx_conf {
	...
	function amportal_generate($verbose=true) {
		...
		$conf_string  = "#;--------------------------------------------------------------------------------\n";
		$conf_string .= "#; ";
		$conf_string .= _("Do NOT edit this file as it is auto-generated by Ringfree PBX. All modifications to");
		$conf_string .= "\n#; ";
		...
		$conf_string .= " http://learn.ringfree.com/configuration_files\n";
		$conf_string .= "#;--------------------------------------------------------------------------------\n\n\n";
		$conf_string .= "#;--------------------------------------------------------------------------------\n#; ";
		$conf_string .= _("All settings can be set from the Advanced Settings page accessible in Ringfree PBX");
		$conf_string .=  "\n#;--------------------------------------------------------------------------------\n\n\n\n";
		$comments = '';
